  ...
  return (
    <section className="py-16 md:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 md:gap-10 pb-16 md:pb-24">
            ...
            >
              ...
              <div
                className="
                  ...
                  w-[85%] bg-white rounded-xl p-4 md:p-6 text-center
                  shadow-lg transition-all duration-500
                  group-hover:-bottom-16 group-hover:shadow-2xl
                "
              >
                <h3 className="text-[rgba(113,113,113,1)] font-semibold text-sm md:text-lg leading-snug mb-4">
                  {card.title}
                </h3>
